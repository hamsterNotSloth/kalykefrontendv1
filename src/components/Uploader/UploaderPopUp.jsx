    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="bg-white max-w-[400px] w-[100%] min-h-[500px] max-h-[700px] overflow-y-auto p-8 rounded-lg shadow-lg relative">
                ...
                {currentLevel == 1 && <ModalUploadStage setCurrentLevel={setCurrentLevel} setSelectedFile={setSelectedFile} selectedFile={selectedFile}  />}
                {currentLevel == 2 && <ModalDetailsUploadStage setCurrentLevel={setCurrentLevel}/>}
                {currentLevel == 3 && <ModalConfirmUploadStage />}
            </div>
        </div>
    )
}
